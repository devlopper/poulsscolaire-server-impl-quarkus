DROP TABLE IF EXISTS TA_PAIEMENT_FRAIS_INSCRIPTION;
DROP TABLE IF EXISTS TA_PAIEMENT;
DROP TABLE IF EXISTS TA_FRAIS_INSCRIPTION;
...
CREATE TABLE TA_IDENTITE (
	...
	ADRESSE_EMAIL VARCHAR(20) NOT NULL COMMENT 'Adresse email de l''identité',
...
CREATE TABLE TA_ELEVE (
	...
	CONSTRAINT TA_ELEVE_UK1 UNIQUE (MATRICULE)
...
CREATE TABLE TA_INSCRIPTION (
	...
	CONSTRAINT TA_INSCRIPTION_FK4 FOREIGN KEY (BRANCHE) REFERENCES TA_BRANCHE(IDENTIFIANT),
	CONSTRAINT TA_INSCRIPTION_UK1 UNIQUE (ELEVE, BRANCHE)
) COMMENT='Table des inscriptions';

CREATE TABLE TA_FRAIS_INSCRIPTION (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant de frais',
	...
	-- Constraints
	CONSTRAINT TA_FRAIS_INSCRIPTION_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_FRAIS_INSCRIPTION_FK1 FOREIGN KEY (FRAIS) REFERENCES TA_FRAIS(IDENTIFIANT),
	CONSTRAINT TA_FRAIS_INSCRIPTION_FK2 FOREIGN KEY (DETAILS) REFERENCES TA_DETAILS_FRAIS(IDENTIFIANT),
	CONSTRAINT TA_FRAIS_INSCRIPTION_FK3 FOREIGN KEY (INSCRIPTION) REFERENCES TA_INSCRIPTION(IDENTIFIANT),
	CONSTRAINT TA_FRAIS_INSCRIPTION_UK1 UNIQUE (FRAIS, DETAILS, INSCRIPTION)
) COMMENT='Table des frais d''inscription';
...
CREATE TABLE TA_PAIEMENT_FRAIS_INSCRIPTION (
	-- Identification
	...
	FRAIS_INSCRIPTION VARCHAR(36) NOT NULL COMMENT 'Identifiant du frais d''inscription',
	...
	-- Constraints
	CONSTRAINT TA_PAIEMENT_FRAIS_INSCRIPTION_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_PAIEMENT_FRAIS_INSCRIPTION_FK1 FOREIGN KEY (PAIEMENT) REFERENCES TA_PAIEMENT(IDENTIFIANT),
	CONSTRAINT TA_PAIEMENT_FRAIS_INSCRIPTION_FK2 FOREIGN KEY (FRAIS_INSCRIPTION) REFERENCES TA_FRAIS_INSCRIPTION(IDENTIFIANT),
	CONSTRAINT TA_PAIEMENT_FRAIS_INSCRIPTION_UK1 UNIQUE (PAIEMENT, FRAIS_INSCRIPTION)
) COMMENT='Table des paiements de frais d''inscriptions';
