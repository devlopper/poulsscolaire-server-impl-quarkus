...
DROP TABLE IF EXISTS TA_LIGNE_BUDGET;
DROP TABLE IF EXISTS TA_LIGNE_BUDGET_AUD;
...
CREATE TABLE TA_LIGNE_BUDGET (
	...
	-- Constraints
	CONSTRAINT TA_LIGNE_BUDGET_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_LIGNE_BUDGET_FK1 FOREIGN KEY (BUDGET) REFERENCES TA_BUDGET(IDENTIFIANT),
	CONSTRAINT TA_LIGNE_BUDGET_FK2 FOREIGN KEY (COMPTE_COMPTABLE) REFERENCES TA_COMPTE_COMPTABLE(IDENTIFIANT),
	CONSTRAINT TA_LIGNE_BUDGET_FK3 FOREIGN KEY (SOURCE_FINANCEMENT) REFERENCES TA_SOURCE_FINANCEMENT(IDENTIFIANT)
) COMMENT='Table des lignes de budgets';

CREATE TABLE TA_LIGNE_BUDGET_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_LIGNE_BUDGET_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des lignes de budgets';
