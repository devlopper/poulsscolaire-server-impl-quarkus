...
CREATE TABLE TA_SCOLARITE (
	...
	CONSTRAINT TA_SCOLARITE_UK1 UNIQUE (ECOLE, BRANCHE, PERIODE)
...
CREATE TABLE TA_FRAIS (
	...
	CONSTRAINT TA_FRAIS_UK1 UNIQUE (RUBRIQUE, TYPE_AFFECTATION, ANCIENNETE, SCOLARITE)
...
CREATE TABLE TA_INSCRIPTION (
	...
	CONSTRAINT TA_INSCRIPTION_UK1 UNIQUE (ELEVE, SCOLARITE)
