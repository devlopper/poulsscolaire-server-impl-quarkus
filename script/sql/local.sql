...
CREATE TABLE TA_ECHEANCE_PAIEMENT_FRAIS_AJUSTE (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_ECHEANCE_PAIEMENT_FRAIS_AJUSTE_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_ECHEANCE_PAIEMENT_FRAIS_AJUSTE_FK1 FOREIGN KEY (FRAIS_AJUSTE) REFERENCES TA_FRAIS_AJUSTE(IDENTIFIANT),
	CONSTRAINT TA_ECHEANCE_PAIEMENT_FRAIS_AJUSTE_FK2 FOREIGN KEY (ECHEANCE) REFERENCES TA_ECHEANCE(IDENTIFIANT),
	CONSTRAINT TA_ECHEANCE_PAIEMENT_FRAIS_AJUSTE_UK1 UNIQUE (FRAIS_AJUSTE, ECHEANCE)
) COMMENT='Table des échéances de paiements des frais ajustés';
