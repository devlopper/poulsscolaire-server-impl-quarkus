DROP TABLE IF EXISTS TA_CONFIGURATION_ECOLE;
DROP TABLE IF EXISTS TA_CONFIGURATION_ECOLE_AUD;
DROP TABLE IF EXISTS TA_OPERATION_COMPTE_COMPTABLE;
DROP TABLE IF EXISTS TA_OPERATION_COMPTE_COMPTABLE_AUD;
DROP TABLE IF EXISTS TA_COMPTE_COMPTABLE_ECOLE;
DROP TABLE IF EXISTS TA_COMPTE_COMPTABLE_ECOLE_AUD;
DROP TABLE IF EXISTS TA_OPERATION_COMPTABLE;
DROP TABLE IF EXISTS TA_OPERATION_COMPTABLE_AUD;
DROP TABLE IF EXISTS TA_EXECUTION_FINANCEMENT;
DROP TABLE IF EXISTS TA_EXECUTION_FINANCEMENT_AUD;
DROP TABLE IF EXISTS TA_FINANCEMENT;
DROP TABLE IF EXISTS TA_FINANCEMENT_AUD;
DROP TABLE IF EXISTS TA_BUDGET;
DROP TABLE IF EXISTS TA_BUDGET_AUD;
DROP TABLE IF EXISTS TA_COMPTE_COMPTABLE;
DROP TABLE IF EXISTS TA_COMPTE_COMPTABLE_AUD;
DROP TABLE IF EXISTS TA_SOURCE_FINANCEMENT;
DROP TABLE IF EXISTS TA_SOURCE_FINANCEMENT_AUD;
DROP TABLE IF EXISTS TA_PLAN_COMPTABLE;
DROP TABLE IF EXISTS TA_PLAN_COMPTABLE_AUD;
...
DROP TABLE IF EXISTS TA_STOCK_DISTRIBUTION_INSCRIPTION;
DROP TABLE IF EXISTS TA_STOCK_DISTRIBUTION_INSCRIPTION_AUD;
DROP TABLE IF EXISTS TA_STOCK_DISTRIBUTION;
DROP TABLE IF EXISTS TA_STOCK_DISTRIBUTION_AUD;
DROP TABLE IF EXISTS TA_STOCK_MOUVEMENT;
DROP TABLE IF EXISTS TA_STOCK_MOUVEMENT_AUD;
DROP TABLE IF EXISTS TA_STOCK_RUBRIQUE;
DROP TABLE IF EXISTS TA_STOCK_RUBRIQUE_AUD;
DROP TABLE IF EXISTS TA_STOCK;
DROP TABLE IF EXISTS TA_STOCK_AUD;
...
DROP TABLE IF EXISTS TA_INSCRIPTION_DECISION_SUBVENTION;
DROP TABLE IF EXISTS TA_INSCRIPTION_DECISION_SUBVENTION_AUD;
DROP TABLE IF EXISTS TA_DECISION_SUBVENTION;
DROP TABLE IF EXISTS TA_DECISION_SUBVENTION_AUD;
...
CREATE TABLE TA_STOCK (
	...
	-- Constraints
	CONSTRAINT TA_STOCK_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_STOCK_FK1 FOREIGN KEY (RUBRIQUE) REFERENCES TA_RUBRIQUE(IDENTIFIANT)
) COMMENT='Table des stocks';

CREATE TABLE TA_STOCK_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des stocks';

CREATE TABLE TA_STOCK_MOUVEMENT (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',

	STOCK VARCHAR(36) NOT NULL COMMENT 'Identifiant du stock',
	QUANTITE INT NOT NULL COMMENT 'Quantité',
	MOTIF VARCHAR(255) COMMENT 'Motif',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_MOUVEMENT_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_STOCK_MOUVEMENT_STOCK_FK1 FOREIGN KEY (STOCK) REFERENCES TA_STOCK(IDENTIFIANT)
) COMMENT='Table des mouvements de stocks';

CREATE TABLE TA_STOCK_MOUVEMENT_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_MOUVEMENT_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des mouvements de stocks';

CREATE TABLE TA_STOCK_RUBRIQUE (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_RUBRIQUE_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_STOCK_RUBRIQUE_FK1 FOREIGN KEY (STOCK) REFERENCES TA_STOCK(IDENTIFIANT),
	CONSTRAINT TA_STOCK_RUBRIQUE_FK2 FOREIGN KEY (RUBRIQUE) REFERENCES TA_RUBRIQUE(IDENTIFIANT),
	CONSTRAINT TA_STOCK_RUBRIQUE_UK1 UNIQUE (STOCK,RUBRIQUE)
) COMMENT='Table des stocks et des rubriques';

CREATE TABLE TA_STOCK_RUBRIQUE_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_RUBRIQUE_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des stocks et des rubriques';

CREATE TABLE TA_STOCK_DISTRIBUTION (
	-- System identifier
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_DISTRIBUTION_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_STOCK_DISTRIBUTION_FK1 FOREIGN KEY (STOCK) REFERENCES TA_STOCK(IDENTIFIANT)
) COMMENT='Table des distributions de stock';

CREATE TABLE TA_STOCK_DISTRIBUTION_AUD (
	-- System identifier
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_DISTRIBUTION_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des distributions de stock';

CREATE TABLE TA_STOCK_DISTRIBUTION_INSCRIPTION (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	
	-- Data
	DISTRIBUTION VARCHAR(36) NOT NULL COMMENT 'Identifiant de distribution de stock',
	INSCRIPTION VARCHAR(36) NOT NULL COMMENT 'Identifiant de l''inscription',
	MOUVEMENT VARCHAR(36) NOT NULL COMMENT 'Identifiant du mouvement',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_DISTRIBUTION_INSCRIPTION_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_STOCK_DISTRIBUTION_INSCRIPTION_FK1 FOREIGN KEY (DISTRIBUTION) REFERENCES TA_STOCK_DISTRIBUTION(IDENTIFIANT),
	CONSTRAINT TA_STOCK_DISTRIBUTION_INSCRIPTION_FK2 FOREIGN KEY (INSCRIPTION) REFERENCES TA_INSCRIPTION(IDENTIFIANT),
	CONSTRAINT TA_STOCK_DISTRIBUTION_INSCRIPTION_FK3 FOREIGN KEY (MOUVEMENT) REFERENCES TA_STOCK_MOUVEMENT(IDENTIFIANT)
) COMMENT='Table des distributions de stock aux inscriptions';

CREATE TABLE TA_STOCK_DISTRIBUTION_INSCRIPTION_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	
	-- Data
	DISTRIBUTION_STOCK VARCHAR(36) NOT NULL COMMENT 'Identifiant de distribution de stock',
	INSCRIPTION VARCHAR(36) NOT NULL COMMENT 'Identifiant de l''inscription',
	MOUVEMENT VARCHAR(36) NOT NULL COMMENT 'Identifiant du mouvement',
	...
	-- Constraints
	CONSTRAINT TA_STOCK_DISTRIBUTION_INSCRIPTION_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des distributions de stock aux inscriptions';
...
CREATE TABLE TA_SCOLARITE (
	...
	MONTANT_PRE_INSCRIPTION INT COMMENT 'Montant de la pré-inscription',
	MONTANT_SUBVENTION INT COMMENT 'Montant de la subvention',
...
CREATE TABLE TA_DECISION_SUBVENTION (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	CODE VARCHAR(26) NOT NULL COMMENT 'Code',

	SCOLARITE VARCHAR(36) NOT NULL COMMENT 'Identifiant de la scolariré',
	...
	-- Constraints
	CONSTRAINT TA_DECISION_SUBVENTION_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_DECISION_SUBVENTION_UK1 UNIQUE (CODE)
) COMMENT='Table des décisions de subvention';

CREATE TABLE TA_DECISION_SUBVENTION_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_DECISION_SUBVENTION_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des décisions de subvention';

CREATE TABLE TA_PAIEMENT_DECISION_SUBVENTION (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',

	MONTANT INT NOT NULL COMMENT 'Montant',
	DECISION_SUBVENTION VARCHAR(36) NOT NULL COMMENT 'Identifiant de la décision de subvention',
	...
	-- Constraints
	CONSTRAINT TA_PAIEMENT_DECISION_SUBVENTION_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_PAIEMENT_DECISION_SUBVENTION_FK1 FOREIGN KEY (DECISION_SUBVENTION) REFERENCES TA_DECISION_SUBVENTION(IDENTIFIANT)
) COMMENT='Table des paiements des décisions de subvention';

CREATE TABLE TA_PAIEMENT_DECISION_SUBVENTION_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_PAIEMENT_DECISION_SUBVENTION_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des paiements des décisions de subvention';
...
CREATE TABLE TA_INSCRIPTION (
	...
	CONSTRAINT TA_INSCRIPTION_FK5 FOREIGN KEY (DECISION_SUBVENTION) REFERENCES TA_DECISION_SUBVENTION(IDENTIFIANT),
...
CREATE TABLE TA_FRAIS_AJUSTE (
	...
	INSCRIPTION VARCHAR(36) NOT NULL COMMENT 'Identifiant de l''inscription',
	STOCK_MOUVEMENT VARCHAR(36) COMMENT 'Identifiant du mouvement de stock',
	MONTANT VARCHAR(36) NOT NULL COMMENT 'Identifiant du montant',
...
CREATE TABLE TA_INSCRIPTION_DECISION_SUBVENTION (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	
	DECISION_SUBVENTION VARCHAR(36) NOT NULL COMMENT 'Identifiant de la décision de subvention',
	INSCRIPTION VARCHAR(36) NOT NULL COMMENT 'Identifiant de l''inscription',
	REJETEE BOOLEAN COMMENT 'Rejeté',
	...
	-- Constraints
	CONSTRAINT TA_INSCRIPTION_DECISION_SUBVENTION_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_INSCRIPTION_DECISION_SUBVENTION_FK1 FOREIGN KEY (DECISION_SUBVENTION) REFERENCES TA_DECISION_SUBVENTION(IDENTIFIANT),
	CONSTRAINT TA_INSCRIPTION_DECISION_SUBVENTION_FK2 FOREIGN KEY (INSCRIPTION) REFERENCES TA_INSCRIPTION(IDENTIFIANT)
) COMMENT='Table des inscriptions des décisions de subvention';

CREATE TABLE TA_INSCRIPTION_DECISION_SUBVENTION_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_PAIEMENT_DECISION_SUBVENTION_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des inscriptions des décisions de subvention';

CREATE TABLE TA_PLAN_COMPTABLE (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_PLAN_COMPTABLE_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_PLAN_COMPTABLE_UK1 UNIQUE (CODE)
) COMMENT='Table des plans comptables';

CREATE TABLE TA_PLAN_COMPTABLE_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_PLAN_COMPTABLE_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des plans comptables';

CREATE TABLE TA_COMPTE_COMPTABLE (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',

	CODE VARCHAR(16) NOT NULL COMMENT 'Code',
	LIBELLE VARCHAR(255) NOT NULL COMMENT 'Libellé',
	PLAN_COMPTABLE VARCHAR(36) NOT NULL COMMENT 'Identifiant du plan comptable',
	...
	-- Constraints
	CONSTRAINT TA_COMPTE_COMPTABLE_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_COMPTE_COMPTABLE_UK1 UNIQUE (PLAN_COMPTABLE,CODE)
) COMMENT='Table des comptes comptables';

CREATE TABLE TA_COMPTE_COMPTABLE_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_COMPTE_COMPTABLE_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des comptes comptables';

CREATE TABLE TA_OPERATION_COMPTABLE (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',

	CODE VARCHAR(16) NOT NULL COMMENT 'Code',
	LIBELLE VARCHAR(255) NOT NULL COMMENT 'Libellé',
	BENEFICIAIRE VARCHAR(255) NOT NULL COMMENT 'Bénéficiaire',
	TYPE_COMPTE VARCHAR(1) NOT NULL COMMENT 'Type de compte',
	ECOLE VARCHAR(255) NOT NULL COMMENT 'Identifiant de l''école',
	PLAN VARCHAR(36) NOT NULL COMMENT 'Identifiant du plan',
	...
	-- Constraints
	CONSTRAINT TA_OPERATION_COMPTABLE_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_OPERATION_COMPTABLE_FK1 FOREIGN KEY (PLAN) REFERENCES TA_PLAN_COMPTABLE(IDENTIFIANT),
	CONSTRAINT TA_OPERATION_COMPTABLE_UK1 UNIQUE (CODE)
) COMMENT='Table des opérations comptables';

CREATE TABLE TA_OPERATION_COMPTABLE_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_OPERATION_COMPTABLE_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des opérations comptables';

CREATE TABLE TA_OPERATION_COMPTE_COMPTABLE (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	
	OPERATION VARCHAR(36) NOT NULL COMMENT 'Identifiant de l''opération comptable',
	COMPTE VARCHAR(36) NOT NULL COMMENT 'Identifiant du compte comptable',
	CODE VARCHAR(16) NOT NULL COMMENT 'Code',
	LIBELLE VARCHAR(255) NOT NULL COMMENT 'Libellé',
	MONTANT INT NOT NULL COMMENT 'Montant',
	...
	-- Constraints
	CONSTRAINT TA_OPERATION_COMPTE_COMPTABLE_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_OPERATION_COMPTE_COMPTABLE_FK1 FOREIGN KEY (OPERATION) REFERENCES TA_OPERATION_COMPTABLE(IDENTIFIANT),
	CONSTRAINT TA_OPERATION_COMPTE_COMPTABLE_FK2 FOREIGN KEY (COMPTE) REFERENCES TA_COMPTE_COMPTABLE(IDENTIFIANT),
	CONSTRAINT TA_OPERATION_COMPTE_COMPTABLE_UK1 UNIQUE (CODE),
	CONSTRAINT TA_OPERATION_COMPTE_COMPTABLE_UK2 UNIQUE (OPERATION,COMPTE)
) COMMENT='Table des opérations de comptes comptables';

CREATE TABLE TA_OPERATION_COMPTE_COMPTABLE_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_OPERATION_COMPTE_COMPTABLE_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des opérations des comptes comptables';

CREATE TABLE TA_COMPTE_COMPTABLE_ECOLE (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	
	COMPTE VARCHAR(36) NOT NULL COMMENT 'Identifiant du compte comptable',
	ECOLE VARCHAR(255) NOT NULL COMMENT 'Identifiant école',
	...
	-- Constraints
	CONSTRAINT TA_COMPTE_COMPTABLE_ECOLE_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_COMPTE_COMPTABLE_ECOLE_FK1 FOREIGN KEY (COMPTE) REFERENCES TA_COMPTE_COMPTABLE(IDENTIFIANT),
	CONSTRAINT TA_COMPTE_COMPTABLE_ECOLE_UK1 UNIQUE (COMPTE,ECOLE)
) COMMENT='Table des comptes comptables d''écoles';

CREATE TABLE TA_COMPTE_COMPTABLE_ECOLE_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_OPERATION_COMPTE_COMPTABLE_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des comptes comptables d''écoles';

CREATE TABLE TA_SOURCE_FINANCEMENT (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_SOURCE_FINANCEMENT_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_SOURCE_FINANCEMENT_UK1 UNIQUE (ECOLE, CODE)
) COMMENT='Table des sources de financements';

CREATE TABLE TA_SOURCE_FINANCEMENT_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_SOURCE_FINANCEMENT_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des sources de financements';

CREATE TABLE TA_BUDGET (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	STATUT VARCHAR(10) NOT NULL COMMENT 'Statut',
	MOTIF VARCHAR(2048) COMMENT 'Raison du statut',
	...
	-- Constraints
	CONSTRAINT TA_BUDGET_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_BUDGET_FK1 FOREIGN KEY (PLAN_COMPTABLE) REFERENCES TA_PLAN_COMPTABLE(IDENTIFIANT),
	CONSTRAINT TA_BUDGET_UK1 UNIQUE (CODE)
) COMMENT='Table des budgets';

CREATE TABLE TA_BUDGET_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_BUDGET_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des budgets';

CREATE TABLE TA_FINANCEMENT (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',

	BUDGET VARCHAR(36) NOT NULL COMMENT 'Identifiant du budget',
	DEPARTEMENT VARCHAR(255) NOT NULL COMMENT 'Identifiant du département',
	COMPTE_COMPTABLE VARCHAR(36) NOT NULL COMMENT 'Identifiant du compte comptable',
	SOURCE_FINANCEMENT VARCHAR(36) NOT NULL COMMENT 'Identifiant de la source de financement',
	MOIS VARCHAR(9) NOT NULL COMMENT 'Mois',
	MONTANT INT NOT NULL COMMENT 'Montant',
	JUSTIFICATION VARCHAR(255) COMMENT 'Justification',
	STATUT VARCHAR(10) NOT NULL COMMENT 'Statut',
	MOTIF VARCHAR(2048) COMMENT 'Motif du statut',
	DATE_LIMITE_SAISIE TIMESTAMP COMMENT 'Date limite de saisie',
	...
	-- Constraints
	CONSTRAINT TA_FINANCEMENT_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_FINANCEMENT_FK1 FOREIGN KEY (BUDGET) REFERENCES TA_BUDGET(IDENTIFIANT),
	CONSTRAINT TA_FINANCEMENT_FK2 FOREIGN KEY (COMPTE_COMPTABLE) REFERENCES TA_COMPTE_COMPTABLE(IDENTIFIANT),
	CONSTRAINT TA_FINANCEMENT_FK3 FOREIGN KEY (SOURCE_FINANCEMENT) REFERENCES TA_SOURCE_FINANCEMENT(IDENTIFIANT)
) COMMENT='Table des financements';

CREATE TABLE TA_FINANCEMENT_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_FINANCEMENT_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des financements';

CREATE TABLE TA_FINANCEMENT_EXECUTION (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',

	FINANCEMENT VARCHAR(36) NOT NULL COMMENT 'Identifiant du financement',
	DATE_ TIMESTAMP COMMENT 'Date',
	MONTANT INT NOT NULL COMMENT 'Montant',
	...
	-- Constraints
	CONSTRAINT TA_FINANCEMENT_EXECUTION_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_FINANCEMENT_EXECUTION_FK1 FOREIGN KEY (FINANCEMENT) REFERENCES TA_FINANCEMENT(IDENTIFIANT)
) COMMENT='Table des exécution des financements';

CREATE TABLE TA_FINANCEMENT_EXECUTION_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_FINANCEMENT_EXECUTION_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des exécutions des financements';
...
CREATE TABLE TA_PAIEMENT (
	...
	FINANCEMENT_EXECUTION VARCHAR(36) COMMENT 'Identifiant de l''exécution du financement',
	...
	CONSTRAINT TA_PAIEMENT_FK1 FOREIGN KEY (FINANCEMENT_EXECUTION) REFERENCES TA_FINANCEMENT_EXECUTION(IDENTIFIANT)
...
CREATE TABLE TA_CONFIGURATION_ECOLE (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_CONFIGURATION_ECOLE_PK PRIMARY KEY (IDENTIFIANT),
	CONSTRAINT TA_CONFIGURATION_ECOLE_UK1 UNIQUE (ECOLE),
	CONSTRAINT TA_CONFIGURATION_ECOLE_FK1 FOREIGN KEY (COMPTE_COMPTABLE_PAIEMENT) REFERENCES TA_COMPTE_COMPTABLE(IDENTIFIANT),
	CONSTRAINT TA_CONFIGURATION_ECOLE_FK2 FOREIGN KEY (SOURCE_FINANCEMENT_PAIEMENT) REFERENCES TA_SOURCE_FINANCEMENT(IDENTIFIANT)
) COMMENT='Table des configurations d''écoles';

CREATE TABLE TA_CONFIGURATION_ECOLE_AUD (
	-- Identification
	IDENTIFIANT VARCHAR(36) NOT NULL COMMENT 'Identifiant',
	...
	-- Constraints
	CONSTRAINT TA_SCOLARITE_AUD_PK PRIMARY KEY (IDENTIFIANT,REV)
) COMMENT='Table des audits des configurations d''écoles';
