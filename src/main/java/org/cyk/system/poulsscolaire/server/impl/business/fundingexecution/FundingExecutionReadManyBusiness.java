 ...
 */
@ApplicationScoped
public class FundingExecutionReadManyBusiness extends
    AbstractIdentifiableReadManyBusiness<FundingExecution, FundingExecutionPersistence,
        FundingExecutionDynamicQuery, FundingExecutionDto, FundingExecutionMapper,
        FundingExecutionGetManyResponseDto> {

  protected FundingExecutionReadManyBusiness() {
    super(FundingExecutionGetManyResponseDto.class);
  }
