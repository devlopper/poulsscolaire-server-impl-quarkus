 ...
 */
@ApplicationScoped
public class DepartmentReadManyBusiness
    extends AbstractIdentifiableReadManyBusiness<Department, DepartmentPersistence,
        DepartmentDynamicQuery, DepartmentDto, DepartmentMapper, DepartmentGetManyResponseDto> {

  protected DepartmentReadManyBusiness() {
    super(DepartmentGetManyResponseDto.class);
  }
