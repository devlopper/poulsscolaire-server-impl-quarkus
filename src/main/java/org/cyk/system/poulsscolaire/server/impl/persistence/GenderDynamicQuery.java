...
/**
 * Cette classe représente la requête dynamique de {@link Gender}.
 *
 * @author Christian
 *
 */
@ApplicationScoped
public class GenderDynamicQuery extends AbstractDynamicQuery<Gender> {
