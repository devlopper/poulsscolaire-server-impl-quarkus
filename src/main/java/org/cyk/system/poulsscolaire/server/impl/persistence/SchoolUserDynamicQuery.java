...
/**
 * Cette classe représente la requête dynamique de {@link SchoolUser}.
 *
 * @author Christian
 *
 */
@ApplicationScoped
public class SchoolUserDynamicQuery extends AbstractDynamicQuery<SchoolUser> {
