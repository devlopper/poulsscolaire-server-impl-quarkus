...
public class BudgetLine extends AbstractIdentifiableAuditable {
  ...
  @NotNull
  @Column(name = COLUMN_MONTH_INDEX, nullable = false)
  ...
  public static final String FIELD_MONTH_INDEX = "monthIndex";
  ...
  public static final String COLUMN_MONTH_INDEX = "MOIS";
