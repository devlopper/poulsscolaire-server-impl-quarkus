...
/**
 * Cette classe représente la requête dynamique de {@link PaymentMode}.
 *
 * @author Christian
 *
 */
@ApplicationScoped
public class PaymentModeDynamicQuery extends AbstractDynamicQuery<PaymentMode> {
   ...
   */
  public PaymentModeDynamicQuery() {
