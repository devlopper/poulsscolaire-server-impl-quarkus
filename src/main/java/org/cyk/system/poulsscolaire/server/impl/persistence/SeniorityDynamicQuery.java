...
/**
 * Cette classe représente la requête dynamique de {@link Seniority}.
 *
 * @author Christian
 *
 */
@ApplicationScoped
public class SeniorityDynamicQuery extends AbstractDynamicQuery<Seniority> {
