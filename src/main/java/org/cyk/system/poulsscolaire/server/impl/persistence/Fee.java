...
@NamedQueries(value = {
    @NamedQuery(name = Fee.QUERY_READ_BY_SCHOOLING_BY_ASSIGNMENT_TYPE_BY_SENIORITY_IDENTIFIER,
...
public class Fee extends AbstractAmountContainer {
  ...
  @Transient
  public String amountValueSumAsString;
  
  @Transient
  public String amountRegistrationSumAsString;
  ...
  public static final String QUERY_READ_BY_SCHOOLING_BY_ASSIGNMENT_TYPE_BY_SENIORITY_IDENTIFIER =
      "Fee.readBySchoolingByAssignmentTypeBySeniority";
  public static final String QUERY_READ_BY_SCHOOLING_BY_ASSIGNMENT_TYPE_BY_SENIORITY_VALUE =
      "SELECT t FROM " + Fee.ENTITY_NAME + " t WHERE t." + Fee.FIELD_SCHOOLING + " = :"
          + FIELD_SCHOOLING + AND + Fee.FIELD_ASSIGNMENT_TYPE + " = :" + FIELD_ASSIGNMENT_TYPE + AND
          + Fee.FIELD_SENIORITY + " = :" + FIELD_SENIORITY;
