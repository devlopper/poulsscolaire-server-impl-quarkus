...
/**
 * Cette classe représente la requête dynamique de {@link FundingSource}.
 *
 * @author Christian
 *
 */
@ApplicationScoped
public class FundingSourceDynamicQuery extends AbstractDynamicQuery<FundingSource> {
   ...
   */
  public FundingSourceDynamicQuery() {
