...
public class AdjustedFeeAmountPaid extends AbstractAdjustedFeeAmount {
  ...
  public static final String QUERY = """
        SELECT TA_FRAIS_AJUSTE.IDENTIFIANT AS IDENTIFIANT
          ...
          ,(CASE WHEN TA_MONTANT.VALEUR_INSCRIPTION - SUM(TA_PAIEMENT_FRAIS_AJUSTE.MONTANT) < 0
           THEN 0 ELSE TA_MONTANT.VALEUR_INSCRIPTION - SUM(TA_PAIEMENT_FRAIS_AJUSTE.MONTANT) END)
